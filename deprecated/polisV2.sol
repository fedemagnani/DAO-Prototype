...
contract DiscoverBlockchainPolis{
    ...
    function _postExecutionGovernanceProposal(uint256 _id) internal {
    ...
    function removeReputation(uint256 _id) public onlyApproved(_id){
        ...
        _postExecutionGovernanceProposal(_id);
    }
    function addedAssociatesOrPartners(uint256 _id)public onlyApproved(_id){
    ...
    function polisAddressChanged(uint256 _id)public onlyApproved(_id){
